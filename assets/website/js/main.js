 ...
 var base_url = "https://woodsberg.com/";
// alert(base_url);
// alert('hello');
...
!(function (g) {
  ...
  g("#preloader").fadeOut("normall", function () {
    ...
    c.on("scroll", function () {
      ...
      e <= 50
        ? (g("header").removeClass("scrollHeader").addClass("fixedHeader"),
          o.attr("src", "img/logos/logo-inner.png"),
          a.attr("src", "assets/website/images/woodsberg_logo.png"),
        ...
        : (g("header").removeClass("fixedHeader").addClass("scrollHeader"),
        ...
        l.attr("src",  base_url + "assets/website/images/woodsberg_logo.png"),
    ...
    g(".collapse-sm").on("click", function () {
      g(".categories .shop-category").slideToggle(),
        g(this).hasClass("current")
          ...
          : (g(this).removeClass("current"), g(this).addClass("current"));
    }),
    ...
    g(document).ready(function () {
      ...
      0 === g("#chBar").length ||
        ...
        g("#services-carousel1").owlCarousel({
          loop: !0,
          responsiveClass: !0,
          dots: !1,
          nav: !0,
        ...
        g("#services-carousel2").owlCarousel({
          loop: !0,
          responsiveClass: !0,
          dots: !1,
          nav: !0,
        ...
        g("#featured-product-carousel").owlCarousel({
          loop: !0,
          responsiveClass: !0,
          dots: !1,
          nav: !0,
          ...
          responsive: {
            ...
            992: { items: 5, margin: 0 },
                ...
                g("#product-category-carousel").owlCarousel({
          loop: false,  // when it is true it will act as slider or loop!=0 it will act as slider
          responsiveClass: !0,
          dots: !1,
          nav: !0,
          smartSpeed: 900,
    ...
    c.on("load", function () {
      ...
      g(".filtering").on("click", "span", function () {
        ...
        g(".portfolio-gallery,.portfolio-gallery-isotope").lightGallery(),
