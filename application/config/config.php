...
// $config['cookie_prefix']   = '';
// $config['cookie_domain']   = 'https://woodsberg.com/';       // or '.yourdomain.com' if subdomains used
// $config['cookie_path']     = '/';
// $config['cookie_secure']   = TRUE;     // keep TRUE for HTTPS
// $config['cookie_httponly'] = TRUE;
// $config['cookie_samesite'] = 'None';   // critical for iframe/incognito
