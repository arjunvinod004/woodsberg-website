...
<head>
    ...
    <meta charset="utf-8" />
    <title>Dashboard | woodsberg </title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Emigo" name="description" />
    <meta content="CVS" name="author" />

    <link rel="shortcut icon" href="<?php echo base_url();?>assets/website/images/woodsberg_logo.png">
    ...
    <link href="<?php echo base_url();?>assets/admin/css/styles.css?v=<?php echo time();?> " rel="stylesheet" type="text/css" />
    ...
    <div class="application-header">
        <div class="application-header__container container">
            <div class="application-header__brand">
                <a href="<?php echo base_url();?>admin/dashboard" class="application-header__brand-logo">
                    <img src="<?php echo base_url();?>uploads/store/woodsberg_logo.png" alt="brand lgo"
            ...
            <div class="application-header__provider">
                <h2 class="application-header__brand-name"><?php echo $Name; ?></h2>
