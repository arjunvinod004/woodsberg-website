...
<div class="">
    <h1 class="application-content__page-heading mt-3 text-center">Despatch Orders</h1>
    <div class="page-content p-2">
        <div class="container-fluid">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-retail-tab" data-bs-toggle="pill"
                        data-bs-target="#despatch-retail" type="button" role="tab" aria-controls="pills-home"
            ...
            <div class="tab-content" id="pills-tabContent">
                <!-- Retail -->
                <div class="tab-pane fade show active order-tab" id="despatch-retail" role="tabpanel"
                    ...
                    <label for="name" class="form-label">Name</label>
                     <input type="text " class="form-control" id="despatch-name"  value="" placeholder="Customer Name">
                    </div>

                
                    <div class="col-md-2">
                    <label for="name" class="form-label">Order No</label>
                     <input type="text " class="form-control" id="despatch-orderno"  value="" placeholder="Order No">
                    </div>

                    <div class="col-md-2">
                    <label for="name" class="form-label">Email</label>
                     <input type="text " class="form-control" id="despatch-email"  value="" placeholder="Email">
                    </div>

                    <div class="col-md-2">
                    <label for="name" class="form-label">Phone No</label>
                     <input type="text " class="form-control" id="despatch-phone"  value="" placeholder="Phone No">
                    </div>

                     <div class="col-md-2 mt-4">
                     <button type="button" class="btn btn-primary" id="despatch-search" data-type="rt">Search</button>
                    </div>
                    ...
                    <div class="row mt-3">
                       ...
                       foreach($orders as $val){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date ("h:i A", strtotime($val['time'])) ;?>
                                            </td>
                                            <td>
                                                <?php echo $val['name'];?>
                                            </td>
                                            ...
                                            <td class="pb-0 pt-0 d-flex">
                                                ...
                                                <button
                                                    class="btn btn-danger btn-sm  p-1 m-2  btn-sm tblEditBtn canceldespatch"
                                                    type="submit"
                                                    data-id="<?php echo $val['order_no']; ?>">cancel<button>
                        ...
                        <div class="">
                            ...
                            foreach($orders as $val){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $val['tracking_id'];?></td>
                            ...
                            <div class="row">
                                <div class="table-responsive-sm">
                                    ...
                                    <div class=" d-flex justify-content-end">
                                        ...
                                        <button class="btn btn-primary btn-lg mx-2" type="button"
                                            style=" font-size:16px !important;">Export Data</button>
