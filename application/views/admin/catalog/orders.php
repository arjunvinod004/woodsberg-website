...
<div class="">
     <h1 class="application-content__page-heading mt-3 text-center">Pending Orders</h1>
    <div class="page-content p-2">
        <div class="container-fluid">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-retail-tab" data-bs-toggle="pill"
                        data-bs-target="#retail-orders" type="button" role="tab" aria-controls="pills-home"
            ...
            <div class="tab-content" id="pills-tabContent">
                <!-- Retail -->
                <div class="tab-pane fade show active order-tab" id="retail-orders" role="tabpanel"
                    ...
                    <div class="row mt-3">
                       ...
                       foreach($orders as $val){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap"><?php echo date ("h:i A", strtotime($val['time'])) ;?>
                                            </td>
                                            <td>
                                                <?php echo $val['name'];?>
                                            </td>
...
<div class="d-flex justify-content-between align-items-center">
    ...
    <div class="col-md-4">
        <label for="label"> Enter Tracking ID</label>
        <input type="text" class="form-control" id="order_track" value="" placeholder="Enter the Tracking Id">
        <span id="order_track_error"></span>
    </div>

    <!-- Right side: Buttons -->
    <div>
        <button class="btn btn-primary btn-lg mx-2 despatch" type="button" style="font-size:16px !important;">
            Despatch
        </button>
