    ...
    <div class="application-content__container container">
        <div class="application-main-menus">
            ...
            <div class="application-main-menus__content">
                <a href="<?php echo base_url('admin/product/index/0'); ?>" class="application-main-menus__items">
                    <span class="application-main-menus__items-icon-wrapper">
                        <img src="https://img.icons8.com/isometric/50/product.png" alt="dishes icon"
                ...
                <!-- <a href="<?php echo base_url('admin/order'); ?>" class="application-main-menus__items">
                    <span class="application-main-menus__items-icon-wrapper">
                        <img src="<?php echo base_url();?>assets/admin/images/main-menu-monitor-icon.svg"
                ...
                <!-- <a href="<?php echo base_url('admin/reports'); ?>" class="application-main-menus__items">
                    <span class="application-main-menus__items-icon-wrapper">
                ...
                <a href="<?php echo base_url('admin/settings'); ?>" class="application-main-menus__items">
                    <span class="application-main-menus__items-icon-wrapper">
