        ...
        <div class="auth-bg">
            ...
            <div class="auth-content">
                ...
                <a href="#" class="auth-logo mb-5">
                    <img src="https://www.coinoneglobal.com/assets/img/header-logo.svg" alt="Logo">
                </a>
                ...
                <form class="login-form" action="<?php echo base_url(); ?>admin/login/userlogin" method="post">
                    ...
                    <div class="powered-by">
                        POWERED BY <a style="color: #4c4c4c;" href="https://www.coinoneglobal.com/"
                            target="_blank">COINONE</a>
                    </div>
                </form>
