...
<?php if($ordertype=='rt'){
    ...
    echo '<a class="butn primary float-end" id="saveuserorder" ><span>Place order</span></a>';
...
<?php if($ordertype == 'ws')
 {
  echo '<a class="butn primary float-end" id="savewholesaleorder"><span>Place Orders</span></a>';
  echo '<a class="butn primary float-end mx-2" href="'.base_url('cart').'"><span>Cart</span></a>';
}                                               
?>
...
<?php if($ordertype == 'bb')
 {
  echo '<a class="butn primary float-end" id="saveb2border"><span>Place Orderss</span></a>';
  echo '<a class="butn primary float-end mx-2" href="'.base_url('cart').'"><span>Cart</span></a>';
}                                               
?>
</div>

<label class="mt-2" style="text-align: right;" class="">Order No : <?php echo $orderno;?></label>
<label style="text-align: right; font-weight: bold;" for=""> Cash on Delivery Not Available</label>
